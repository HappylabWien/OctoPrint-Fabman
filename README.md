...
- `[fabman]` / `min_price_per_job`:  Here you can set a minimum price per print job. If you do not need this feature, set the price to `0` (do not delete the parameter).
